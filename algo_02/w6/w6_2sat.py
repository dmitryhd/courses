...
def test():
    cases = [ ['test_cases/case01.txt', True],
              ['test_cases/case02.txt', False],
              ['test_cases/case03.txt', True],
            ]
    for case in cases:
...
def main():
    if len(sys.argv) == 1:
        ...
        files = ['test_cases/2sat1.txt',
                 'test_cases/2sat2.txt',
                 'test_cases/2sat3.txt',
                 'test_cases/2sat4.txt',
                 'test_cases/2sat5.txt',
                 'test_cases/2sat6.txt'
                ]
        for f in files:
            n, edges = load_file(f)
            cc = solve_2sat(n, edges)
